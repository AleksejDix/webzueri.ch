<template>
  <section class="bg-primary-light pattern min-h-screen px-2">
    <header class="container mx-autopx-4 py-12">
      ...
      >
        News from the web zurich community
      </h1>
    </header>
    <div
      class="container rounded-lg  p-2 mx-auto bg-primary-dark shadow-blue-darker"
    >
        ...
        >
          <article class="owl-lg h-full flex flex-col">
            <aside>
              <nuxt-link
                to="/"
                class="text-on-dark-primary hover:text-fuchia-light group no-underline inline-block"
              >
                <user-card
                  size="xl"
            ...
            <a
              ...
              target="_blank"
              rel="noopener"
              class="group transition flex-1 relative block bg-primary hover:bg-primary-dark rounded-lg p-4 text-white no-underline whitespace-normal shadow-blue"
            >
              <svg
                viewBox="0 0 24 8"
              ...
              >
                ...
                >
                  ...
                  >
                    <img
                      loading="lazy"
                      class="absolute pin-t pin-x w-full"
