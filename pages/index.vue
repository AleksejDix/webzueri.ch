<template>
  <div id="content" class="bg-primary-light pattern">
                ...
                <div class="w-full shadow-blue rounded-lg py-4 px-6 flex items-center bg-primary-dark">
                  <div class="icon pr-4 md:pr-6">
                    <div class=" transition w-16 h-16 rounded-full flex items-center justify-center">
                      <svg class="w-10 h-10 fill-primary-dark" :style="{fill: item.color}">
    ...
    <div class="">
      <section class="container mx-auto p-2 rounded">
              ...
              <ul class="flex flex-wrap list-reset">
                <li class="p-2 flex-no-grow" v-for="sponsor in event.sponsors" :key="sponsor.id">
                  <a class="p-4 rounded-lg block mr-8" :href="sponsor.website">
                    <img class="transition w-auto h-20 opacity-64 hover:opacity-100 max-w-xs" :src="sponsor.logo.url" :alt="sponsor.name">
                  </a>
                </li>
              </ul>
            </section>
        ...
        <div class="text-center py-16">
          <Button size="big" to="/events/1">Past Events</Button>
        </div>
      </section>
    </div>
    <section-feedbacks />
