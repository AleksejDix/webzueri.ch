  ...
  <div id="content">
      ...
      <div class="container mx-auto px-2">
        <div class="lg:flex">
          <div class="lg:w-2/5 px-2 pb-8">
            <h1
              class="mb-4 leading-tight text-3xl md:text-4xl text-base text-on-dark-primary text-shadow font-display font-bold tracking-wide uppercase"
            >People making
                ...
                <div class="w-full border border-white rounded-lg py-4 px-6 flex items-center">
                  <div class="icon pr-4 md:pr-6">
                    <div
                      ...
                      class="border border-white rounded-full w-12 h-12 flex items-center justify-center"
                    >
                      <svg
                      ...
                      >
                        <path d="m10 7h-8v6h8v5l8-8-8-8z"></path>
                      </svg>
                    </div>
                  </div>
    ...
    <div class="pattern bg-primary-light">
      <section class="container mx-auto p-2 rounded">
        ...
        >
          <h2
            class="leading-tight text-21 md:text-4xl text-on-dark-primary text-shadow font-display font-bold tracking-wide"
          >Next Event: {{ event.date | date }}</h2>
          ...
          <div v-else>
            <div class="xl:flex">
              ...
              <article class="w-full flex-1 xl:w-1/3 p-4" v-if="event.talks.length < 3">
                <div
                  class="p-4 h-full border-blue-dark border-2 border-dashed owl items-center justify-center rounded-lg bg-primary"
                >
                  <h3
                    class="text-on-dark-primary text-2xl md:text-3xl leading-tight font-semibold"
                  >{{3 - event.talks.length }} Spot left</h3>
                  <p
                    class="text-on-dark-primary leading-normal"
                  >Sharing is caring! Why not talk about your latest project, the great tool you found or the problem you just solved recently?</p>
              ...
              <ul class="flex flex-wrap list-reset">
                <li class="p-2 flex-no-grow" v-for="sponsor in event.sponsors" :key="sponsor.id">
                  <a class="p-4 rounded-lg block mr-8" :href="sponsor.website">
                    <img
                      class="transition w-auto h-20 opacity-64 hover:opacity-100"
