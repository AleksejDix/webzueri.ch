<template>
  ...
  <div v-else id="content">
    <section class="bg-indigo-darkest shadow-lg pb-8">
      <div class="sm:max-w-lg lg:max-w-2xl mx-auto pt-12">
        <div class="lg:flex">
          <div class="lg:w-2/5 p-4">
            ...
            <p class=" leading-normal  text-xl md:text-2xl text-grey-lighter">
    ...
    <div class="next-event bg-purple-dark">
      <section class="container mx-auto p-2 rounded">
        ...
        <header class="py-8 flex justify-around px-2">
          ...
          <a :href="event.meetupLink" rel="noopener" target="_blank" class="min-w-32 bg-yellow no-underline leading-tight antialiased uppercase flex items-center justify-center text-center  py-4 px-6 text-gray md:flex-none hover:bg-gray font-semibold rounded text-sm tracking-wide">Secure a seat</a>
        </header>
