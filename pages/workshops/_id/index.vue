  ...
  <div v-if="workshop">
    <div class="max-w-5xl mx-auto px-2">
      <div class="bg-white rounded-lg shadow">
        <div v-if="workshop.banner" class="p-8">
          <img v-if="workshop.banner.url" class="rounded-lg" :src="workshop.banner.url" alt="">
          <section class="md:flex md:px-4 md:-m-4">
            <aside class="md:px-4 md:w-1/4 md:-mt-24">
              <img class="w-24 md:w-full border shadow rounded-full" :src="workshop.speakers[0].speakerPicture.url"
        :alt="workshop.speakers[0].name">
              <div class="inline-flex md:p-2 rounded-full owl-x">
                <a :href="workshop.speakers[0].twitterHandler" target="_blank">
                  <svg xmlns="http://www.w3.org/2000/svg" class="w-8 h-8 rounded-full" viewBox="0 0 400 400">
            ...
            <div class="p-4 md:w-3/4">
              <div class="spacer-y">
                ...
                <h1 class="text-4xl font-display leading-tight pt-4 mb-8" v-if="workshop.name">
                  {{workshop.name}} <strong> by {{workshop.speakers[0].name}}</strong></h1>

                <div class="bg-fuchsia-lightest  p-8 rounded-lg">
                  <Button>asd</Button>
                </div>

                <prose  v-if="workshop.description" v-html="$md.render(workshop.description)">
