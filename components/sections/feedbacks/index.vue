        ...
        <div class="flex-no-shrink w-64 md:w-96 p-2" v-for="feedback in feedbacks" :key="feedback.id">
          ...
          <article class="relative">
            ...
            <header class="bg-primary shadow-blue px-8 pt-12 pb-2 rounded-lg relative z-10">
              ...
              <img class=" absolute pin-t pin-l -mt-8 ml-6 block w-16 shadow-blue rounded-full" v-if="feedback.speaker" :src="feedback.speaker.speakerPicture.url" />
              <img v-if="feedback.sponsor" class="absolute pin-r pin-t w-auto h-6 mt-4 mr-4" :src="feedback.sponsor.logo.url" alt="">
            </header>
