<template functional>
  <svg xmlns="http://www.w3.org/2000/svg" class="hidden">
    ...
    <symbol id="meetup" viewBox="0 0 24 24">
      <path
    ...
    <symbol id="presentation-play" viewBox="0 0 24 24">
      <g>
        <path
          class="fill-primary"
        ...
        <path
          class="fill-secondary"
          d="M15.51 8.14a1 1 0 0 1 0 1.72l-5 3A1 1 0 0 1 9 12V6a1 1 0 0 1 1.51-.86l5 3z"
        />
      </g>
    </symbol>
    ...
    <symbol id="security-important" viewBox="0 0 24 24">
      <path
        class="fill-secondary"
