<template>
  <nuxt-link class="talk link overflow-hidden" :to="`./${talk}`">
    <div class="flex items-center -ml-8">
      <div class=" px-4 py-6 rounded-l userimage ">
        <div class="">
          <img class="rounded-full w-24 h-24 border-4 bg-grey-lightest" :src="talk.content.speaker.content.image" alt="">
        </div>
      </div>
      <div class="-ml-46 px-4 pb-2">
        <h2 class="font-light pb-2">{{talk.name}}</h2>
        <h3>by {{talk.content.speaker.name}}</h3>
      </div>
    </div>
  </nuxt-link>
</template>
