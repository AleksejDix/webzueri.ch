<template>
  <transition name="fade">
    <div style="background-color: rgba(47,54,95,.82)" class="model-mask  fixed pin overflow-auto p-4" v-if="show" @close.self="show = false">
          ...
          <form class="w-full max-w-md px-12" @submit.prevent="">
            <div class="flex flex-wrap -mx-3 mb-6">
              <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                ...
                <wz-input label="e-mail" placeholder="fan@webzueri.ch" type="email" />
            ...
            <div class="flex flex-wrap -mx-3 mb-6">
              <div class="w-full px-3">
                ...
                <textarea rows="4" class="appearance-none block w-full bg-grey-lighter text-grey-darkest border border-grey-lighter rounded py-3 px-4 mb-3" id="grid-password" type="password" placeholder="I will talk about Networking unicorns"></textarea>
